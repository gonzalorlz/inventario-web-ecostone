...
class _RecipeDetailPageState extends State<RecipeDetailPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //         height: 280,
      //         width: MediaQuery.of(context).size.width,
      //         //decoration: BoxDecoration(image: DecorationImage(image: AssetImage(widget.data), fit: BoxFit.cover)),
      //         child: Container(
      ...
      //             child: Text(
      //               widget.data.categorias.length.toString(),
      //               style: TextStyle(
      //                   color: Colors.white,
      //                   fontSize: 18,
      ...
      //           shrinkWrap: true,
      //           padding: EdgeInsets.zero,
      //           itemCount: widget.data.categorias.length,
      //           physics: NeverScrollableScrollPhysics(),
      //           itemBuilder: (context, index) {
      //             // return IngridientTile(
      //             //  ' data: widget.data.categorias,'
      //             // );
      //           },
      //         ),
      //         // Tutorials
